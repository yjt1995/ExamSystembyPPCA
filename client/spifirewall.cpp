...
GUID  spiFirewall::UDPguid={0x4d1e91fd,0x116a,0x44aa,{0x8f,0xd4,0x1d,0x2c,0xf2,0x7b,0xd9,0xa9}};

GUID  spiFirewall::UDPchainguid={0xd3c21121,0x85e1,0x48f3,{0x9a,0xb6,0x23,0xd9,0x0c,0x73,0x07,0xef}};

GUID  spiFirewall::TCPguid={0x4d1e91fd,0x116a,0x44aa,{0x8f,0xd4,0x1d,0x2c,0xf2,0x7b,0xd9,0xaa}};

GUID  spiFirewall::TCPchainguid={0xd3c21121,0x85e1,0x48f3,{0x9a,0xb6,0x23,0xd9,0x0c,0x73,0x07,0xe0}};


spiFirewall::spiFirewall(QObject *parent) :
    QObject(parent)
{
    //总的服务提供者数量
    totalprotos=0;
...
spiFirewall::~spiFirewall()
{

}

void spiFirewall::initFirewall()
{
    InstallProviders();
}

void spiFirewall::deleteFirewall()
{
    RemoveProviders();
}
...
//释放服务提供者信息
//////////////////////////////////////////////////////////////////////////
void spiFirewall::FreeProviders()
{
...
//安装TCP的LSP
//////////////////////////////////////////////////////////////////////////
void spiFirewall::InstallTCPProviders()
{
    int                i;
    int                provcnt;
    int                CataIndex;
...
//安装UDP的LSP
//////////////////////////////////////////////////////////////////////////
void spiFirewall::InstallUDPProviders()
{
    int                i;
    int                provcnt;
    int                CataIndex;
...
//安装两个服务提供者
//////////////////////////////////////////////////////////////////////////
void spiFirewall::InstallProviders()
{
    InstallUDPProviders();
    InstallTCPProviders();
}
...
//拆卸服务提供者
//////////////////////////////////////////////////////////////////////////
void spiFirewall::RemoveProviders()
{
    int  errorcode;
    BOOL signal=TRUE;
